   ...
   return (
    <div className="space-y-8">
      {hasPermission ? (
        ...
        <div className="bg-slate-100 p-8 rounded-xl border border-dashed border-slate-300 flex flex-col items-center gap-4 text-center">
          <Package className="w-10 h-10 text-slate-300" />
          <h4 className="text-xs font-black uppercase tracking-widest text-slate-400">Modo Leitura Ativo</h4>
          <p className="text-xs font-bold text-slate-400 uppercase">Você não possui permissão para gerenciar modelos ou estoque de ração.</p>
        </div>
      )}
